...
| R5 | **Interpreter correctness drift.** Preview says fine, Xcode says error. | High | Golden-test corpus; a strictness lint pass that flags constructs our interpreter tolerates but swiftc rejects; optional Phase 7 real-swiftc verification service. |
