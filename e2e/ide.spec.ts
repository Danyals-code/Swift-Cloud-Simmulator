...
test('Code preview stays centered at every zoom and cannot be panned', async ({ page }) => {
  ...
  // Manual zoom stays centered, and Code never adopts Design's pan gestures.
  ...
  expect(await bounds()).toEqual(beforeDrag)
