...
const SYMBOLS: Readonly<Record<string, readonly SymbolShape[]>> = {
  ...
  /*
    Added by frequency rather than alphabetically, which is the rule the register set
    for this table: these are the names that turned up in the seven sample screens and
    in the shapes of app people write - a mail list, a settings screen, a media row.

    `tray` is the one that found the gap. It was in neither table, so an inbox row drew
    the fallback `▢` next to "Inbox", and a hollow square in a mail list is not an
    approximation of anything.
  */
  tray: [
    s('M3.6 14.4h4.2l1.2 2.2h6l1.2-2.2h4.2'),
    s('M3.6 14.4 6.2 6.2a1.4 1.4 0 0 1 1.34-1h8.92a1.4 1.4 0 0 1 1.34 1l2.6 8.2v3.4a1.4 1.4 0 0 1-1.4 1.4H5a1.4 1.4 0 0 1-1.4-1.4v-3.4Z'),
  ],
  'tray.fill': [
    f('M6.2 6.2a1.4 1.4 0 0 1 1.34-1h8.92a1.4 1.4 0 0 1 1.34 1l2.6 8.2h-4.98l-1.2 2.2h-6l-1.2-2.2H3.6l2.6-8.2Z'),
    f('M3.6 15.8h5.02l1.2 2.2h4.36l1.2-2.2h5.02v2a1.4 1.4 0 0 1-1.4 1.4H5a1.4 1.4 0 0 1-1.4-1.4v-2Z'),
  ],
  paperclip: [
    s('M18.2 11.6 10.4 19.4a4.4 4.4 0 0 1-6.22-6.22l8.6-8.6a2.94 2.94 0 0 1 4.16 4.16l-8.6 8.6a1.47 1.47 0 0 1-2.08-2.08l7.8-7.8'),
  ],
  shield: [s('M12 3.2 19.4 6v6c0 4.2-3 7.4-7.4 8.8C7.6 19.4 4.6 16.2 4.6 12V6L12 3.2Z')],
  'shield.fill': [f('M12 3.2 19.4 6v6c0 4.2-3 7.4-7.4 8.8C7.6 19.4 4.6 16.2 4.6 12V6L12 3.2Z')],
  waveform: [
    s('M3.4 12v1.6', 1.5),
    s('M7 7.6v8.8', 1.5),
    s('M10.6 4.4v15.2', 1.5),
    s('M14.2 8.6v6.8', 1.5),
    s('M17.8 6v12', 1.5),
    s('M21.4 10.4v3.2', 1.5),
  ],
  percent: [
    s('M6.4 4.6a2.4 2.4 0 1 0 0 4.8a2.4 2.4 0 1 0 0-4.8Z', 1.5),
    s('M17.6 14.6a2.4 2.4 0 1 0 0 4.8a2.4 2.4 0 1 0 0-4.8Z', 1.5),
    s('M19.2 4.8 4.8 19.2'),
  ],
  thermometer: [
    s('M14 14.2V5.6a2 2 0 0 0-4 0v8.6a4 4 0 1 0 4 0Z'),
    s('M12 8.4v7.2', 1.4),
  ],
  hourglass: [
    s('M6.6 3.6h10.8'),
    s('M6.6 20.4h10.8'),
    s('M7.6 3.6v3.2L12 11l4.4-4.2V3.6'),
    s('M7.6 20.4v-3.2L12 13l4.4 4.2v3.2'),
  ],
  alarm: [
    s('M12 6.6a7 7 0 1 0 0 14a7 7 0 1 0 0-14Z'),
    s('M12 10v3.6l2.4 1.6', 1.5),
    s('M4.4 5.6 7.4 3'),
    s('M19.6 5.6 16.6 3'),
  ],
  iphone: [
    s('M7 3.6h10a1.6 1.6 0 0 1 1.6 1.6v13.6a1.6 1.6 0 0 1-1.6 1.6H7a1.6 1.6 0 0 1-1.6-1.6V5.2A1.6 1.6 0 0 1 7 3.6Z'),
    s('M10.4 5.8h3.2', 1.4),
  ],
  tv: [
    s('M4 6.2h16a1.4 1.4 0 0 1 1.4 1.4v8.2a1.4 1.4 0 0 1-1.4 1.4H4a1.4 1.4 0 0 1-1.4-1.4V7.6A1.4 1.4 0 0 1 4 6.2Z'),
    s('M8.4 20.4h7.2', 1.5),
  ],
  keyboard: [
    s('M3.4 6.6h17.2a1.4 1.4 0 0 1 1.4 1.4v8a1.4 1.4 0 0 1-1.4 1.4H3.4A1.4 1.4 0 0 1 2 16V8a1.4 1.4 0 0 1 1.4-1.4Z'),
    s('M7.6 14.4h8.8', 1.4),
    dot(6, 9.8, 0.85),
    dot(9.4, 9.8, 0.85),
    dot(12.8, 9.8, 0.85),
  ...
  airplane: [
    f('M12 2.2c.9 0 1.6 1.5 1.6 3.4v3.1l7.2 4.2v2l-7.2-2.1v4.1l2.4 1.8v1.6L12 19.2l-4 1.1v-1.6l2.4-1.8v-4.1L3.2 14.9v-2l7.2-4.2V5.6c0-1.9.7-3.4 1.6-3.4Z'),
  ],
  'chart.pie': [
    s('M12 3.4a8.6 8.6 0 1 0 0 17.2a8.6 8.6 0 1 0 0-17.2Z'),
    s('M12 12V3.4'),
    s('M12 12h8.6'),
  ],
  'list.dash': [
  ...
  'text.aligncenter': [s('M4 5.6h16'), s('M6.5 10.2h11'), s('M4 14.8h16'), s('M6.5 19.4h11')],
  'text.alignright': [s('M4 5.6h16'), s('M9 10.2h11'), s('M4 14.8h16'), s('M9 19.4h11')],
}
